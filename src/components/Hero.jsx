    ...
    <Container className="pt-5 pb-8 text-center lg:pt-8">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        ...
        <span className="relative whitespace-nowrap text-blue-600">
          ...
          <span className="relative">Almighty God</span>
        </span>{' '}
      </h1>
      <h2 className="mx-auto mt-6  max-w-3xl font-display text-3xl font-medium tracking-tight text-slate-800 sm:text-5xl">The Lord has come the second time and spoken words!</h2>
